"use strict";
$(function () {
    let guessedLetters = document.querySelector('#guessedLetters'), lastInput = document.querySelector('.search'), instructionsBTN = document.querySelector('#instructions-btn'), instructText = document.getElementById('instructions-content'), hintContent = document.querySelector('#hint-content'), avatarForm = document.querySelector('#avatarForm');
    ...
    class Avatar {
        constructor(userName, userEmail, userPass, userAvatar, localData) {
            this.name = userName;
        ...
        setUserInfo() {
            if (localStorage.getItem('avatar') !== null) {
                ...
                $('#userBTN').css('background', `url(/images/avatars/avatar-${this.localData.userAvatar}.JPG) no-repeat center/cover`);
    ...
    avatarForm.addEventListener('submit', function (e) {
        ...
        if (document.querySelector('input[name="avatar"]:checked') === null) {
            ...
            let avatarForm = document.getElementById(formID);
            avatarForm.reset();
            responsive();
    ...
    let startGame = {
        ...
        createLetters: function () {
            for (let i = 0; i <= this.word.length - 1; i++) {
                ...
                document.getElementById('letterContainer').appendChild(tag);
            }
